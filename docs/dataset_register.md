...
| AIForge-Doc v2 | candidate | [dataset card](https://huggingface.co/datasets/Scam-AI/AIForge-Doc-v2) | dataset card states CC BY 4.0, but underlying SROIE subset retains research-use terms | promising paired cross-generator test; filter by source licence |
